...
if __name__ == "__main__":
    ...
    for s in tqdm(range(S)):
        ...
        if args.mode != "sgd-noise":
            weight_dict = network.unflatten_weights(weight_sample)
        network.load_weights(weight_dict, sess)
    ...
    y_pred = (1 / float(S)) * y_pred_sum # added float
    ...
    utils.save_data("SWAG", args.network_name, y_pred, y_test)
