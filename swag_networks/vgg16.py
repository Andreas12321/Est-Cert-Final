...
class VGG16:
    ...
    def __init__(self, imgs, n_classes, weights=None, sess=None, dropout=DROPOUT_RATE):
        ...
        self.VGG16_VAR_DIMS = {
            "conv1_1_W": (3, 3, D, 64), "conv1_1_b": (64),
            ...
            "fc2_W": (512, 4096), "fc2_b": (4096),
            "fc3_W": (4096, self.n_classes), "fc3_b": (self.n_classes)
        }
    ...
    def convlayers(self):
        ...
        with tf.name_scope('conv1_1') as scope:
            ...
            kernel = tf.Variable(self.conv_initializer([3, 3, D, 64]), name='weights')
    ...
    def fc_layers(self):
        ...
        with tf.name_scope('fc2') as scope:
            fc2w = tf.Variable(self.fc_initializer([512, 4096]), name='weights')
